...
$currenturl = new moodle_url('/badges/certificates/elements.php', array('id' => $certid));
...
if ($totalcount) {
    echo $output->heading(get_string('elementscontained', 'badges', $totalcount), 4);
    ...
    echo $output->notification(get_string('nobadgecertificateelms', 'badges'));
