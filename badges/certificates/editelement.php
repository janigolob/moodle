...
if ($element->certtype == CERT_TYPE_COURSE) {
    ...
    $navurl = new moodle_url('/badges/certificates/index.php', array('type' => $element->certtype, 'id' => $element->courseid));
...
$currenturl = new moodle_url('/badges/certificates/editelement.php', array('id' => $element->id));
...
if ($form->is_cancelled()) {
    redirect(new moodle_url('/badges/certificates/elements.php', array('id' => $element->certid)));
